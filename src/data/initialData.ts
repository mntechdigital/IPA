...
export const INITIAL_CMS_STATE: CmsState = {
  ...
  "settings": {
    ...
    "metaDescription": "Independent media research observatory focused on journalism, digital platforms, public opinion, and institutional accountability.",
    "ogImage": "https://images.unsplash.com/photo-1495020689067-958852a7765e?auto=format&fit=crop&w=2200&q=85",
    "contactEmail": "info@mediaresearch.org",
    "researchDeskEmail": "research@mediaresearch.org",
    "pressEmail": "media@mediaresearch.org",
    "officeAddress": "Level 7, Press & Research Tower, 42 Gulshan Avenue, Dhaka 1212",
    ...
    "footerBranding": {
      ...
      "tagline": "Rigorous empirical research observing media ecosystems, newsroom autonomy, algorithmic governance, and democratic public spheres.",
      "copyrightNotice": "© 2021–2026 Institute of Public Accountability. Open Access Research.",
      "licenseNotice": "All data and publications distributed under Creative Commons Attribution 4.0 International (CC BY 4.0)."
    },
    "footerNavigation": [
      {
        "title": "Observatory",
  ...
  "homePage": {
    ...
    "heroSubtitle": "The Institute of Public Accountability operates empirical observatories tracking journalism, digital platforms, public trust, and institutional transparency in an era of platform restructuring.",
    "heroSubtitleBn": "ইনস্টিটিউট অব পাবলিক অ্যাকাউন্টেবিলিটি প্ল্যাটফর্ম পুনর্গঠনের যুগে সাংবাদিকতা, ডিজিটাল প্ল্যাটফর্ম, জনবিশ্বাস ও প্রাতিষ্ঠানিক জবাবদিহিতা পর্যালোচনায় স্বাধীন ও তথ্যভিত্তিক মানমন্দির পরিচালনা করে।",
    ...
    "tenetSubtitleBn": "আমাদের কাজ স্বাধীন গবেষণা ও গঠনমূলক বিশ্লেষণের মাধ্যমে পরিবর্তনশীল গণমাধ্যম ব্যবস্থাকে আরো সুস্পষ্টভাবে অনুধাবন করতে সাহায্য করে।",
    "homeMetrics": [
      {
        "id": "m1",
        "label": "Experience",
  ...
  "contactPage": {
    "hero": {
      ...
      "subtitle": "Direct communication channels for academic researchers, investigative journalists, policy institutions, and public dataset requests.",
      "subtitleBn": "গবেষক, সাংবাদিক ও অংশীদারদের জন্য আমাদের যোগাযোগের দরজা সর্বদা উন্মুক্ত।",
  ...
  "publications": [
    {
      ...
      "status": "Published",
      "downloadUrl": "#",
      "abstract": "Comprehensive research document published by the Institute of Public Accountability under open-access methodology."
    },
    {
      "id": "pub-2",
      "title": "Local Press Viability Index: Methodology & Findings",
  ...
  "inquiries": [
    {
      ...
      "message": "Requesting access to the complete South Asian Newsroom Editorial Structure Dataset (2022–2025) raw CSV for an academic comparative survey.",
    ...
    },
    {
      ...
      "message": "We are interested in referencing IPA's automated OCR print indexing methodology for our upcoming Nordic newsroom diversity study.",
      "requestedDataset": "The IPA Broadcast Coding Standard: An Operational Guide",
      "status": "reviewed",
    ...
    },
    {
      ...
      "message": "Seeking permissions to cite the 2025 National Media Trust Barometer statistics in an upcoming weekend investigative feature.",

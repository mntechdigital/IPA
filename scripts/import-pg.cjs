...
async function main() {
  ...
  for (const beat of backup.researchBeat) {
    const data = {
      ...
      leadFellowsBn: beat.leadFellowsBn ?? null,
      metrics: beat.metrics ?? [],
      metricsBn: beat.metricsBn ?? null,
      overview: beat.overview ?? [],
      overviewBn: beat.overviewBn ?? null,
      keyQuestions: beat.keyQuestions ?? [],
      keyQuestionsBn: beat.keyQuestionsBn ?? null,
      methodologyDetails: beat.methodologyDetails ?? [],
      methodologyDetailsBn: beat.methodologyDetailsBn ?? null,
      caseStudies: beat.caseStudies ?? [],
      caseStudiesBn: beat.caseStudiesBn ?? null,
      publications: beat.publications ?? [],
      publicationsBn: beat.publicationsBn ?? null,
      summary: beat.summary ?? null,
      methodology: beat.methodology ?? null,
      primaryMethodologies: beat.primaryMethodologies ?? [],
      primaryMethodologiesBn: beat.primaryMethodologiesBn ?? null,
      sampleInquiries: beat.sampleInquiries ?? [],
      sampleInquiriesBn: beat.sampleInquiriesBn ?? null,
  ...
  for (const team of backup.teamMember) {
    const data = {
      id: team.id,
      name: team.name,
      nameBn: team.nameBn ?? null,
      role: team.role,
      roleBn: team.roleBn ?? null,
      category: team.category,
      teamType: team.teamType,
      image: team.image,
      bio: team.bio,
      bioBn: team.bioBn ?? null,
      fullBio: team.fullBio,
      fullBioBn: team.fullBioBn ?? null,
      researchInterests: team.researchInterests ?? [],
      researchInterestsBn: team.researchInterestsBn ?? null,
      focusAreas: team.focusAreas ?? [],
      focusAreasBn: team.focusAreasBn ?? null,
      education: team.education,
      educationBn: team.educationBn ?? null,
      recentPublications: team.recentPublications ?? [],
      email: team.email,
  ...
  for (const inf of backup.inquiry) {
    const data = {
      ...
      topic: inf.topic,
      message: inf.message,
      requestedDataset: inf.requestedDataset ?? null,
      status: inf.status,
    };
